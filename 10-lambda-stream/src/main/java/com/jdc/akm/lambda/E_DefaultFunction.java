...
public class E_DefaultFunction {
...
//		useOperator();
	...
	static void useSupplier() {
		...
		System.out.println("Use Supplier ::: " + s.get());
	}
	...
	static void usePredicate() {
		...
		Predicate<Integer> combine = p.and(p1);
	...
	static void useConsumer(int a, int b){
		Consumer<Integer> c1 = x -> System.out.println("Use consumer ::: "+(x%2));
		Consumer<Integer> c2 = y -> System.out.println("y is greater than 10 ::: "+(y == 0));
